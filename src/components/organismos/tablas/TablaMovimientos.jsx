    ...
    const eliminar = (p) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                await categoryDelete({ id: p.id, id_user: p.id_user });
            }
        });
    }
                    ...
                    {data
                        ...
                        .map((item) => {
                            return (
                                <tr key={item.id}>
                                    <th scope="row">
                                        <Situacion $bgColor={item.state=="1"? "green":"red"} />
                                    </th>
                                    <td data-title="Fecha">{item.date}</td>
                                    <td data-title="Descripción">{item.description}</td>
                                    <td data-title="Categoría">{item.desc_category}</td>
                                    <td data-title="Cuenta">{item.desc_account}</td>
                                    <td data-title="Monto">{item.currency_value}</td>
